...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'F2M Field Management'); ?> - Admin Dashboard</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/admin/dashboard" class="<?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">
                <span class="icon">📊</span> Dashboard
            </a>

            <div class="nav-label">Management</div>
            <a href="/admin/users" class="<?php echo e(request()->is('admin/users*') ? 'active' : ''); ?>">
                <span class="icon">👥</span> Area Managers
            </a>
            <a href="/admin/stores" class="<?php echo e(request()->is('admin/stores*') ? 'active' : ''); ?>">
                <span class="icon">🏪</span> Stores
            </a>
            <a href="/admin/schedules" class="<?php echo e(request()->is('admin/schedules*') ? 'active' : ''); ?>">
                <span class="icon">📅</span> Schedules
            </a>

            <div class="nav-label">Monitoring</div>
            <a href="/admin/check-ins" class="<?php echo e(request()->is('admin/check-ins*') ? 'active' : ''); ?>">
                <span class="icon">📍</span> Check-ins
            </a>
            <a href="/admin/activity-logs" class="<?php echo e(request()->is('admin/activity-logs*') ? 'active' : ''); ?>">
                <span class="icon">📋</span> Activity Logs
            </a>
            <a href="/admin/sop-reports" class="<?php echo e(request()->is('admin/sop-reports*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\kelvin.yohandi\.gemini\antigravity\scratch\am-tracker-api\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>